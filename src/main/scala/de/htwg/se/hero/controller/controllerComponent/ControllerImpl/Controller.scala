package de.htwg.se.hero.controller.controllerComponent.ControllerImpl
...
import de.htwg.se.hero.model.boardComponent.{BoardInterface, CellInterface}
import de.htwg.se.hero.model.boardComponent.boardImpl.Board
...
import de.htwg.se.hero.HeroModule
