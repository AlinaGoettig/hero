package de.htwg.se.hero.controller

import de.htwg.se.hero
import de.htwg.se.hero.controller.controllerComponent.ControllerImpl.Controller
import de.htwg.se.hero.model.boardComponent.boardImpl.{Board, Cell}
import de.htwg.se.hero.model.playerComponent.Player
import de.htwg.se.hero.util.{CellFactory, CreaturelistIterator, ObstacleListIterator, SetCommand}
import org.scalatest._
//import de.htwg.se.hero.util.Observable
