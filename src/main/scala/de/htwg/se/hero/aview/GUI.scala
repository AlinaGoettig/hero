...
import de.htwg.se.hero.model.boardComponent.CellInterface
...
class GUI(controller: ControllerInterface) extends Frame with Observer {
    ...
    def mainmenu(): Unit = {
        ...
        val file = Paths get "src/main/scala/de/htwg/se/hero/aview/Audio/Menu.mp3"
        val player: FileJavaSoundPlayer = new FileJavaSoundPlayer(file)
        player.volume = 30
        player.play()

        contents = new ImagePanel() {
            imagePath = "src/main/scala/de/htwg/se/hero/aview/Graphics/UI/Menubackground.png"
            ...
            contents += new BoxPanel(Orientation.Vertical) {
                ...
                contents += new Label() {
                    opaque = false
                    icon = new ImageIcon("src/main/scala/de/htwg/se/hero/aview/Graphics/UI/Font.png")
                }
                ...
                contents += new BoxPanel(Orientation.Vertical) {
                    ...
                    contents += new ShortButton("New Game",30,new Color(200, 200, 200))(true)(true) {
                        icon = new ImageIcon("src/main/scala/de/htwg/se/hero/aview/Graphics/UI/Buttonframe.png")
                        reactions += {
    ...
    def gamerun(): Unit = {
        ...
        //Music
        val file = Paths get "src/main/scala/de/htwg/se/hero/aview/Audio/Combat.mp3"
        val player = new FileJavaSoundPlayer(file)
        player.volume = 25
        player.play()

        contents = new ImagePanel {
            imagePath = "src/main/scala/de/htwg/se/hero/aview/Graphics/UI/Background.png"
            contents += new BoxPanel(Orientation.Vertical) {
                opaque = false
                contents += new BoxPanel(Orientation.Vertical) {
                                    ...
                                    contents += new CoorButton(j, i, controller.getCreature(controller.board.field, i, j), controller) {
                                        ...
                                        if (!cell.player.name.equals("none")) {
                                            ...
                                            if (cell.name.equals(" _ ")) {
                                                icon = new ImageIcon("src/main/scala/de/htwg/se/hero/aview/Graphics/UI/Marker.png")
                                            }
                                        }
    ...
    def loadcellimage(cellname: String)(mode: Int): ImageIcon = {
        ...
        if (mode == 1) {
            new ImageIcon("src/main/scala/de/htwg/se/hero/aview/Graphics/Model/" + name + ".png")
        } else if (mode == 2) {
            new ImageIcon("src/main/scala/de/htwg/se/hero/aview/Graphics/Model/" + name + "activ.png")
        }else {
            new ImageIcon("src/main/scala/de/htwg/se/hero/aview/Graphics/Model/" + name + "attack.png")
        }
    }
